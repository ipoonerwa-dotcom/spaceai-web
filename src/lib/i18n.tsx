...
const D: Record<string, Record<Lang, string>> = {
  ...
  "a.limitRange": { zh: "单个地址累计上限 $10,000", en: "$10,000 total per address", ja: "1アドレス合計 $10,000 まで", ko: "주소당 합계 $10,000" },
  "a.rewardFloor": { zh: "奖励门槛", en: "Reward threshold", ja: "報酬の下限", ko: "보상 기준" },
  "a.rewardFloorNote": {
    zh: "低于此金额的仓位仍可正常质押计息,但不会为推荐人产生直推奖和团队奖(业绩照常计入)。",
    en: "Positions below this still stake and earn interest normally, but generate no direct or team reward for your referrer (volume still counts).",
    ja: "これを下回るポジションも通常どおりステークして利息を得られますが、紹介者への直接報酬・チーム報酬は発生しません(実績には計上されます)。",
    ko: "이 금액 미만의 포지션도 정상적으로 스테이킹되고 이자가 붙지만, 추천인에게 직접·팀 보상이 발생하지 않습니다(실적에는 반영됩니다).",
  },
  "a.belowReward": {
    zh: "此金额低于 $100 奖励门槛 —— 可以质押,但不会产生推荐奖励。",
    en: "Below the $100 reward threshold — you can still stake, it just earns your referrer nothing.",
    ja: "$100 の報酬下限を下回ります —— ステークは可能ですが、紹介報酬は発生しません。",
    ko: "$100 보상 기준 미만입니다 — 스테이킹은 가능하지만 추천 보상은 발생하지 않습니다.",
  },
  "a.remaining": { zh: "剩余可投额度", en: "Remaining capacity", ja: "残り枠", ko: "남은 한도" },
  "a.errBelowMin": { zh: "金额过小,请提高质押数量。", en: "Amount too small — increase the stake.", ja: "金額が小さすぎます。数量を増やしてください。", ko: "금액이 너무 적습니다. 수량을 늘리세요." },
